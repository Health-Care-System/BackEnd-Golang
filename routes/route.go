...
func SetupRoutes(e *echo.Echo) {
	...
	gUsers.POST("/ws/chats/:transaction_id", controllers.CreateRoomchatsController, UserJWT)
	gUsers.GET("/ws/chats/join-roomchat/:roomchat_id", controllers.JoinRoomchatController, UserJWT)
	gUsers.GET("/ws/chats/:roomchat_id", controllers.GetRoomchatController, UserJWT)
	...
	gDoctors.GET("/ws/chats/join-roomchat/:roomchat_id", controllers.JoinRoomchatController, DoctorJWT)
	gDoctors.GET("/ws/chats/:roomchat_id", controllers.GetRoomchatController, DoctorJWT)
	gDoctors.GET("/ws/chats", controllers.GetAllRoomchatsController, DoctorJWT)
	gDoctors.GET("/ws/chats/client/:roomchat_id", controllers.GetClientController, DoctorJWT)
